              ...
              <label className="flex items-start space-x-3 cursor-pointer">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  <div className="text-xs text-slate-500 mt-1 space-y-1">
                    <p>• <strong>Checked:</strong> Unlimited deduction against gains.</p>
          ...
          {!results.hasLoss ? (
            ...
            <>
              ...
              <div className="relative space-y-4">
                ...
                {/* VOID OVERLAY (Inside this wrapper only) */}
                ...
                {/* CARD B: SMART SWITCH (Simplified - CTA moved out) */}
                <div className={`p-5 rounded-xl border-2 transition-all relative ${
                ...
                {/* SEPARATE CTA BOX (Distinct Visual Hierarchy) */}
                {/* Included in Relative Wrapper so VOID covers it too */}
                <div className="bg-slate-900 rounded-xl p-5 shadow-lg border border-slate-800 mt-6">
                   ...
                   <a href="/" className={`block w-full text-center font-bold py-3 rounded-lg transition-colors ${
                      results.recommendation === 'switch'
                      ? 'bg-blue-600 text-white hover:bg-blue-700 shadow-md ring-1 ring-blue-500' // Blue CTA to stand out
              ...
              {/* COMPLIANCE CHECKBOX - MOVED OUTSIDE RELATIVE WRAPPER */}
              {/* This ensures it is always clickable even if VOID is active */}
